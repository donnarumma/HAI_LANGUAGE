% main HAI_LANGUAGE_DICTIONARY_main_Frosolone_8_dueRun
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
clear MDPsub;
...
%     maxT                                      = par_series.level(end).maxT;
    ...
    %% run the inference
        ...
        SEP = '//';
        root_dir = ['~' SEP 'bin' SEP 'HAI_LANGUAGE_PERSONAL_MIRKO' SEP 'HAI_LANGUAGE_TESTS'];
...
save([root_result SEP char],'Result','-v7.3');
return