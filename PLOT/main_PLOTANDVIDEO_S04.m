...
% GT                     = ['WE PRESENT A NOVEL COMPUTATIONAL MODEL THAT USES HIERARCHICAL ACTIVE INFERENCE TO SIMULATE THE READING PROCESS AND EYE MOVEMENTS DURING READING' ... 
                         % ' THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN READING PROCESS'];
% GT=                     ['THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN READING PROCESS'];
GT                     = ['WE PRESENT A NOVEL COMPUTATIONAL MODEL THAT USES HIERARCHICAL ACTIVE INFERENCE TO SIMULATE THE READING PROCESS AND EYE MOVEMENTS DURING READING' ... 
                         ' THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN READING PROCESS'];
%
% GT                     = ['THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN READING PROCESS'];
DICTIONARY = DICTIONARY_save(['SacDic_' test_name],dic_dir,[DICTIONARY_words(tmpDIC);DICTIONARY_getWords({GT})],{GT},1,1);

pltparams.GT=DICTIONARY.Sentence{1};
fprintf('GT=%s\n',HAI_retrieveLevel(pltparams.GT));
...
% GT2                     = ['WE PRESENT A NOVEL COMPUTATIONAL MODEL THAT USES HIERARCHICAL ACTIVE INFERENCE TO SIMULATE THE READING PROCESS AND EYE MOVEMENTS DURING READING. ' ... 
                         % ' THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN PROCESS. PROCESS.'];
GT2                     = ['WE PRESENT A NOVEL COMPUTATIONAL MODEL THAT USES HIERARCHICAL ACTIVE INFERENCE TO SIMULATE THE READING PROCESS AND EYE MOVEMENTS DURING READING. ' ... 
                         ' THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN SCENARIO. .'];
% 
% GT2                     = ['THE COMPUTATIONAL MODEL IS ABLE TO HELP TO PREDICT A SPECIFIC TIME PERIOD IN A SINGLE HUMAN PROCESS PROCESS.'];
