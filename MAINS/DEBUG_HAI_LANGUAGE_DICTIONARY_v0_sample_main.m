function MDP=DEBUG_HAI_LANGUAGE_DICTIONARY_v0_sample_main(dictionary)
% function DEBUG_HAI_LANGUAGE_DICTIONARY_v0_sample_main
...
DICTIONARY                         = dic_fun();
% dictionary                         = 'DICTIONARY_v7'; % no class
% dictionary                         = 'DICTIONARY_v8'; % class
wstart                             = 19;                   
wstart                             = 1;                   
...
desc     = langparams.description;
PLOT_BAR_modes({MDP},{desc},dictionary,langparams.ID,rtmode,'',save_dir)
