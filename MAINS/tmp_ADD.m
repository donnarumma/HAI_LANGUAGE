...
MDP_s1              =load ('DICTIONARY/BERT_v1_S02/MDP_STEP001.mat');
...
dic_dir             = ['.' SEP 'frosolone' SEP dic_name  SEP];
mkdir(dic_dir);
addpath(dic_dir);
...
syllables           =cellfun(@(x)(HAI_retrieveLevel(x)),DICTIONARY.Syllable,'UniformOutput',false);%HAI_retrieveLevel(DICTIONARY.Syllable{1});%(MDP.MDP.MDP,'');
words               =cellfun(@(x)(HAI_retrieveLevel(x)),DICTIONARY.Word,    'UniformOutput',false);%HAI_retrieveLevel(DICTIONARY.Syllable{1});%(MDP.MDP.MDP,'');
sentences           =cellfun(@(x)(HAI_retrieveLevel(x)),DICTIONARY.Sentence,'UniformOutput',false);%HAI_retrieveLevel(DICTIONARY.Syllable{1});%(MDP.MDP.MDP,'');
