% function HAI_LANGUAGE_BERT_LOOP_sample01_main
irng                            =  6;
...
idsentences                     = [13, 93, 1 , 1]; 
% THIS PAPER IS ALSO MENTIONED IN THE SCIENTIFIC JOURNAL OF MATHEMATICS AND COMPUTER SCIENCE AND COMPUTER ALGEBRA JOURNAL ARTICLES
% THIS PAPER IS ALSO MENTIONED IN THE SCIENTIFIC JOURNAL OF MATHEMATICS AND COMPUTER SCIENCE AND COMPUTER ALGEBRA JOURNAL ARTICLES
