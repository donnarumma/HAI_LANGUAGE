% function main_BERT_AI_LOOP_v2
irng                            =  3;
deleteoldsentences              =  1;
langparamsmode                  = 21;
rtmode                          =  0;
SEP                             = '//';
starting_dic                    = 'BERT_sentence';
...
idsentences                     = randi(10,1,10);%[1,1,1,1,1];%[13, 93, 1 , 1]; % THIS PAPER IS ALSO MENTIONED IN THE SCIENTIFIC JOURNAL OF MATHEMATICS AND COMPUTER SCIENCE AND
