% main Sim1_DM_4l.m
% Simulation 1: reading 100 words of four letters from the BERT Dictionary, Dyslexic Model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear;

irng                                = randi([1 10],1);  %'default';
length_of_words                     = 4;                % words of four letters
paramsmodes                         = 13;               % select the SUB parameter: Dyslexic Model, two level (Syllables, Words), noise on level 1 and 2
