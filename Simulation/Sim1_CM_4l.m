% main Sim1_CM_4l.m
% Simulation 1: reading 100 words of four letters from the BERT Dictionary, Control Model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear;

irng                                = randi([1 10],1);  %'default';
length_of_words                     = 4;                % words of four letters
paramsmodes                         = 10;               % select the SUB parameter: Control Model, two level (Syllables, Words), no noise
