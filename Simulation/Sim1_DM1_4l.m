% main Sim1_DM1_4l.m
% Simulation 1: reading 100 words of four letters from the BERT Dictionary,
% Dyslexic Model - DM1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear;
...
paramsmodes                         = 11;               % select the SUB parameter: Dyslexic Model - DM1, two level (Syllables, Words), noise on level 1 (syllables)
